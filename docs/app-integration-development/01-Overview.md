...
* [Classic User OAuth](06-OAuth-Functionality.md#classic-user-oauth) acts as a PagerDuty user via an authorization code grant, with a blanket `read` or `write` scope. It can be authorized by a user on any account, and can be published.
