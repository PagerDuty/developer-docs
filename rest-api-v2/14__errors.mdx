---
title: "Errors"
excerpt: "Errors returned by the PagerDuty API"
---
...
| 401 | Unauthorized | Caller did not supply credentials or did not provide the correct credentials. See <Link to="/docs/rest-api-v2/authentication/">Authentication</Link>. |
...
| 429 | Too Many Requests | The caller is making requests too frequently. Wait a moment before making further requests and make them at a reduced rate. See  <Link to="/docs/rest-api-v2/rate-limiting/">Rate  Limiting</Link>. |
