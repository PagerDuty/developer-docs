...
<Alert variant="info">
  <Alert.Heading>Upgrade to v2 Webhooks</Alert.Heading>
  Looking for webhooks on notes, or more details in your webhook payload? Add a new <strong>Generic V2 Webhook</strong> extension to receive the <Alert.Link><Link to="/docs/webhooks/v2-overview/">v2 webhooks payload</Link></Alert.Link>.
</Alert>
...
<Tabs defaultActiveKey="incident.trigger" variant="tabs" className="webhook-examples">
  <Tab eventKey="incident.trigger" title="incident.trigger">
...
```
  ...
  <Tab eventKey="incident.acknowledge" title="incident.acknowledge">
...
```
  ...
  <Tab eventKey="incident.unacknowledge" title="incident.unacknowledge">
...
```
  ...
  <Tab eventKey="incident.resolve" title="incident.resolve">
...
```
  ...
  <Tab eventKey="incident.assign" title="incident.assign">
...
```
  ...
  <Tab eventKey="incident.escalate" title="incident.escalate">
...
```
  ...
  <Tab eventKey="incident.delegate" title="incident.delegate">
