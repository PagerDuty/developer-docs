---
title: "Types"
excerpt: "Data types seen throughout the PagerDuty API"
---
import Alert from 'react-bootstrap/Alert'

<Alert variant="warning">
<Alert.Heading>The null value</Alert.Heading>
...
<Alert variant="info">
  An <code>id</code> field is never <code>null</code>.
</Alert>
...
<Alert variant="info">
    A <code>uuid</code> field is never <code>null</code>.
</Alert>
...
<Alert variant="info">
A boolean field is never <code>null</code>.
</Alert>
...
<Alert variant="info">
An array field is never <code>null</code>.

If there are no values for the associated field, the value will be an empty array (<code>[]</code>).
</Alert>
