---
title: "Send a Change Event"
excerpt: "Send a sample event for the Change Events API from this guide"
---
...
----------------------------------------------------------------- | ---------------- | -----------
`routing_key`<br/> <div classname="required">Required</div>       | String           | This is the 32 character Integration Key for an Integration on a Service. The same Integration Key can be used for both alert and change events.
`payload.summary`<br/> <div classname="required">Required</div>   | String           | A brief text summary of the event. Displayed in PagerDuty to provide information about the change. The maximum permitted length of this property is 1024 characters.
