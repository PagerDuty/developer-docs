---
title: "Retrieve Incident Details"
excerpt: ""
---
...
<Alert variant="info">
  ...
  The description of the structure of the <code>log_entry.channel</code> produced here only reflects what it was observed to be as of this writing. A full specification of the <code>log_entry.channel</code> property's schema has not yet been published in our API Reference because it may be subject to change until a permanent structure is decided upon.",
</Alert>

Channel Type   | Description
-------------- | ------------
`api`          | It will contain the properties of the event that was received through the integration. <br/> **Note:** This type appears for both Event and REST API.
